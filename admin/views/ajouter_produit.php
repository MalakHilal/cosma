...
<head>
    ...
    <title>Ajouter un Produit - Ma Rosa</title>
...
<div class="container mb-5">
    <div class="card p-4 shadow-sm border-0 card-rounded-lg">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="heading-highlight"><i class="fa-solid fa-plus-circle me-2"></i>Ajouter un Produit</h3>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="row gy-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="caracteristique" class="form-control form-controls-rounded" rows="4" required></textarea>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Prix d'achat (€)</label>
                    <input type="number" step="0.01" name="prix_achat" class="form-control form-controls-rounded" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Prix de vente (€)</label>
                    <input type="number" step="0.01" name="prix_vente" class="form-control form-controls-rounded" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Quantité en stock</label>
                    <input type="number" name="stock" class="form-control form-controls-rounded" required>
                </div>
            </div>
            <div class="text-end mt-4">
                <button type="submit" class="btn btn-primary-custom btn-pill"><i class="fa-solid fa-save me-1"></i> Enregistrer</button>
            </div>
        </form>
    </div>
</div>
